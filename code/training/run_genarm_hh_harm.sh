cuda=0
exp_name=hh_genarm_harm_r8_1epoch
objective=harm
...
output_dir=./HH-RLHF/exp_genarm_harm
...
accelerate launch --gpu_ids $cuda --main_process_port 29501 --num_processes $num_GPU train_genarm.py \
