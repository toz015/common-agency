...
class PBLoraConfig(PeftConfig):
    ...
    r1: int = field(default=8, metadata={"help": "Lora attention dimension"})
    r2: int = field(default=8, metadata={"help": "Lora attention dimension"})
    obj_num: int = field(default=2, metadata={"help": "Number of objective"})
    # lora_num: int = field(default=2, metadata={"help": "Number of LoRA"})
    pref_vec_init: Optional[list[float]] = field(
        default=None,
        metadata={
            "help": "",
        },
    ...
    def __post_init__(self):
        self.peft_type = PeftType.PBLORA
        self.target_modules = (
